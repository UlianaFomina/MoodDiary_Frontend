...
import { Goals } from "../../components/GoalsComponents/goals/goals";
    ...
    <div className="new-entry container-bg">
      ...
      <div className="wrap">
        <div className="planing-header">
          <button
            className="planing-header-btn todo-btn"
            onClick={() => setActiveComponent("todo")}
          >
            ToDo
          </button>
          <button
            className="planing-header-btn habits-btn"
            onClick={() => setActiveComponent("habits")}
          >
            Habits
          </button>
          <button
            className="planing-header-btn goals-btn"
